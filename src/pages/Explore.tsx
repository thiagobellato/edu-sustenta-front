...
export default function Explore() {
  ...
  const { data: trails = [], isLoading, error } = useQuery<Trail[]>({
    ...
    queryFn: async () => {
      try {
        ...
        // Se for um objeto com results (paginação), retorna results
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <Card className="border-destructive">
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="mb-2 text-xl font-semibold text-[#012030]">Erro ao carregar trilhas</h3>
            <p className="text-[#012030]/60 mb-4">
              Não foi possível carregar as trilhas. Tente novamente mais tarde.
            </p>
            <Button 
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredTrails.map((trail) => (
            <Card
              key={trail.id}
              onClick={(e) => {
                // Não navega se clicar no botão
                if ((e.target as HTMLElement).closest('button')) {
                  return;
                }
                navigate(`/explore/${trail.id}`);
              }}
            ...
            >
              ...
              <CardContent className="pt-0">
                <div className="mb-4 flex flex-wrap gap-2">
                  ...
                  {trail.difficulty != null && trail.difficulty !== '' && (
                ...
                <Button 
                  ...
                  className="mt-4 w-full bg-[#012030] text-white hover:bg-[#012030]/90 transition-colors"
                >
